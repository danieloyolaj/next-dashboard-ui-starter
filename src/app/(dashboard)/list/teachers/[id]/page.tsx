  ...
  return(
    <div className="flex-1 p-4 flex flex-col gap-4 xl:flex-row">
      ...
      <div className="mt-4 bg-white rounded-md p-4 h-[800px]">
        <h1 className="text-2xl font-semibold mb-4">Teacher&apos;s Schedule</h1>
        <BigCalendar />
      </div>
      </div>
      ...
      <div className="w-full xl:w-1/3 flex flex-col gap-4">
        <div className="bg-white p-4 rounded-md">
          ...
          <div className="mt-4 flex gap-4 flex-wrap text-xs text-gray-500">
            <Link href="/" className="p-3 rounded-md bg-lamaSky">Teacher&apos;s Classes</Link>
            ...
            <Link href="/" className="p-3 rounded-md bg-lamaSkyLight">Teacher&apos;s Exams</Link>
          </div>
        </div>
        <Performance />
        <Announcements />
