...
const schema = z.object({
  username: z
    .string()
    .min(3, {message: 'Username must be between 3 and 20 characters long!'})
    .max(20, {message: 'Username must be between 3 and 20 characters long!'}),
  ...
  bloodType: z.string().min(2, {message: 'Blood Type is requiered!'}),
  birthday: z.date({message: 'First name is requiered!'}),
    ...
    <form className="flex flex-col gap-8" onSubmit={onSubmit}>
      ...
      <span className='text-xs text-gray-400 font-medium'>Personal Information</span>
        ...
        <label className='text-xs text-gray-500 flex items-center gap-2 cursor-pointer' htmlFor='img'>
          <Image src="/upload.png" alt="imagen" width={28} height={25}/>
